                    ...
                    <div class="row">
                      <div class="col-12">
                        ...
                        <div class="invoice p-3 mb-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       @php
                                           ...
                                           $total = $total + ($product->costingPrice) * $product->quantity
                                       @endphp
                                        <td>{{$key + 1}}</td>
                                        <td>{{$product->details->name}} - {{$product->details->thickness}}" - {{$product->details->color}}</td>
                                        <td>({{$product->quantity}} X {{$product->costType  }}{{ unitHelper($product->costType)}}) = {{$product->quantity * $product->costType}}<strong> Pis </strong> </td>
                                         <td>
                                            <strong >
                                        ...
                                        <td>
                                            ...
                                            {{currencySignHelper($order->type )}}  {{round(($product->costingPrice) * $product->quantity,2)}}</td>
                                      </tr>
                                    @empty
                                        N/A
                                    @endforelse
                          ...
                          <!-- /.row -->
                          <hr style="width: 100%">
                         <strong>Head Office :</strong>  9/B/1. Hosne Dalan Road. Nam. Bagicha. Lalbagh. Dhaka, Cell 01748 986129. 01761 898555 <br>
